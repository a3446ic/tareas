...
BEGIN
    ...
    BEGIN
        ...
        WHERE 1=1
	        AND CRH.BATCHNAME LIKE CASE WHEN IN_FILENAME = '' OR IN_FILENAME IS NULL THEN '%%' ELSE IN_FILENAME END
	        AND CRH.ESTADOREG = 'ENVIADA'
	    GROUP BY CRH.IDMEDIADOR,CRH.IDSUBCLAVE,MM.NOMBRE,MM."APELLIDO/RAZON_SOCIAL",CRH.IDPAIS,SC.SOCIEDAD,CRH.MESCIERRE,CRH.FECHA_EFECTO_ANUALIDAD,CRH.NUMFACTURA,MM.POSITIONSEQ,CRH.BATCHNAME,CRH.IDDIVISA
