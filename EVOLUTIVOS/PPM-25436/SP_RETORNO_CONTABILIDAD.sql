...
-- v12: se añade la condición  [ and UT1.REMOVEDATE=TO_DATE('22000101','yyyymmdd') ]  en la consulta inicial y se generaliza el NAME de los creditos
-- v13: se excluyen los tipos de movimiento = 13 y situación = 12
---------------
...
----Comienza a escribir en DEBUG
    ...
    CALL EXT.LIB_GLOBAL_CESCE :w_debug (i_Tenant, 'STARTING with SESSION_USER: ' || SESSION_USER, vProcedure || ' version ' || cVersion || ' pPlRunSeq ' || pPlRunSeq, io_contador);
...
/*    (
    ...
    AND (
    	     (SO.ORDERID, TX.LINENUMBER, TX.SUBLINENUMBER) 
    				NOT IN (SELECT ORDERID, LINENUMBER, SUBLINENUMBER
	...
	AND NOT (TX.GENERICATTRIBUTE9 = '13' AND TX.GENERICATTRIBUTE10 = '12')
	;
/*	
