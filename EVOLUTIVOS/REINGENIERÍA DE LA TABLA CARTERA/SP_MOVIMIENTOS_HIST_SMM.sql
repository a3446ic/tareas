CREATE OR REPLACE PROCEDURE "EXT"."SP_MOVIMIENTOS_HIST_SMM" (IN IN_FILENAME Varchar(120)) LANGUAGE SQLSCRIPT 
...
DECLARE cReportTable CONSTANT VARCHAR(50) := 'SP_MOVIMIENTOS_HIST_SMM';
...
IF IN_FILENAME LIKE '%MVCAR%' THEN 
    ...
    FOR i AS mvcar DO
        ...
        INSERT INTO EXT.EXT_MOVIMIENTO_CARTERA_CREDITO_HIST_SMM
        VALUES
        (
        i.IDMODALIDAD,
        i.NUM_POLIZA,
