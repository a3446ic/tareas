CREATE OR REPLACE FUNCTION EXT.GET_AUTO_MEDIADOR_TRASPASOS(filtro	VARCHAR(250), departamento VARCHAR(250), nombreDepartamento VARCHAR(250), tipoUsuario VARCHAR(250), nombre VARCHAR(250)) 
