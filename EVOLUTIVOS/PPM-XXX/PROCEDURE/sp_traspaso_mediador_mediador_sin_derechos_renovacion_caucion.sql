...
DO BEGIN
	...
	DELETE FROM EXT.CSE_DEBUG WHERE PROCESO = 'sp_traspaso_mediador_mediador_sin_derechos_renovacion_caucion' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
	...
	SELECT NUM_POLIZA,NUM_AVAL_HOST,COD_MEDIADOR,FECHA_INICIO,FECHA_FIN,FECHA_EFECTO_TRASPASO,MODIF_USER,MODIF_SOURCE,ACTIVO FROM EXT.CARTERA WHERE NUM_POLIZA = 47350 AND NUM_FIANZA IS NULL;
	
	CALL EXT.sp_traspaso_mediador_mediador_sin_derechos_renovacion_caucion_SMM(2043,'TRASPASO1-2039->1128');
	
	SELECT NUM_POLIZA,NUM_AVAL_HOST,COD_MEDIADOR,FECHA_INICIO,FECHA_FIN,FECHA_EFECTO_TRASPASO,MODIF_USER,MODIF_SOURCE,ACTIVO FROM EXT.CARTERA WHERE NUM_POLIZA = 47350 AND NUM_FIANZA IS NULL;
	
	CALL EXT.sp_traspaso_mediador_mediador_sin_derechos_renovacion_caucion_SMM(2044,'TRASPASO2-1128->2039');
	
	SELECT NUM_POLIZA,NUM_AVAL_HOST,COD_MEDIADOR,FECHA_INICIO,FECHA_FIN,FECHA_EFECTO_TRASPASO,MODIF_USER,MODIF_SOURCE,ACTIVO FROM EXT.CARTERA WHERE NUM_POLIZA = 47350 AND NUM_FIANZA IS NULL;
	
	CALL EXT.sp_traspaso_mediador_mediador_sin_derechos_renovacion_caucion_SMM(2045,'TRASPASO3-2039->1128');
	
	SELECT NUM_POLIZA,NUM_AVAL_HOST,COD_MEDIADOR,FECHA_INICIO,FECHA_FIN,FECHA_EFECTO_TRASPASO,MODIF_USER,MODIF_SOURCE,ACTIVO FROM EXT.CARTERA WHERE NUM_POLIZA = 47350 AND NUM_FIANZA IS NULL;
	
	
SELECT * FROM EXT.CSE_DEBUG WHERE PROCESO = 'sp_traspaso_mediador_mediador_sin_derechos_renovacion_caucion' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
