CREATE OR REPLACE PROCEDURE EXT.sp_traspaso_operaciones_especiales_caucion (IN caseId BIGINT)
LANGUAGE SQLSCRIPT 
AS
/*
	----------------------------------------------------------------------------------------------- 
...
BEGIN
    ...
    FOR CT AS CURSOR_TRASPASOS DO
        ...
        SELECT 
	        ...
	        END*/NULL P_ESPECIAL_EMISION, --P_ESPECIAL_EMISION
	        /*CASE
	        	-- SI ES LA ANUALIDAD ACTUAL SE COGE LA DE LA SOLICITUD DE TRASPASO
	        	WHEN C_ACT.RN = 1 THEN CT.P_ESPECIAL_RENOVACION
	        	-- SI NO ES LA ANUALIDAD ACTUAL SE COGE LA QUE VIENE POR DEFECTO
	        	ELSE C.P_ESPECIAL_RENOVACION
	        END*/NULL P_ESPECIAL_RENOVACION, --P_ESPECIAL_RENOVACION
	        C."NIF_TOMADOR",
	        C."NOMBRE_TOMADOR",
	        ...
	        CASE
	        	...
	        	WHEN C.NUM_AVAL_HOST = CT.COD_AVAL THEN CT.FECHA_EFECTO_SOLICITUD
...
CALL EXT.sp_traspaso_operaciones_especiales_caucion(vCASEID);
...
--AND NUM_POLIZA = 9008150 
ORDER BY ACTIVO,COD_MEDIADOR,NUM_AVAL_HOST,NUM_POLIZA,NUM_ANUALIDAD;
