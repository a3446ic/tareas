...
-- DECLARE vCASEID BIGINT = 1982;

-- TRUNCATE TABLE EXT.CARTERA;
-- INSERT INTO EXT.CARTERA SELECT *,NULL,NULL FROM EXT.CARTERA_BKP_SMM;
-- CALL EXT.SP_REVISION_CARTERA;

-- DELETE FROM EXT.CSE_DEBUG WHERE PROCESO LIKE '%sp_traspaso_porcentaje_mediador_con_derechos_caucion%';
...
-- CALL EXT.sp_traspaso_porcentaje_mediador_con_derechos_caucion(vCASEID,'Traspaso Pólizas y Avales-GM-426');
...
-- SELECT * FROM EXT.CSE_DEBUG WHERE PROCESO LIKE '%sp_traspaso_porcentaje_mediador_con_derechos_caucion%';
