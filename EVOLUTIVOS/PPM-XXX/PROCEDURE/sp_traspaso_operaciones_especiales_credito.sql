...
DELETE FROM EXT.CSE_DEBUG WHERE PROCESO LIKE '%SP_TRASPASO_OPERACIONES_ESPECIALES_CREDITO%' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
SELECT * FROM EXT.SOLICITUD_TRASPASO WHERE CASEID= 1901;

SELECT * FROM EXT.CARTERA WHERE NUM_POLIZA = 22610 AND COD_MEDIADOR = '0012' AND COD_SUBCLAVE = '0001' ORDER BY COD_MEDIADOR,NUM_ANUALIDAD;
CALL EXT.SP_TRASPASO_OPERACIONES_ESPECIALES_CREDITO(1901,'WS');

SELECT NUM_ANUALIDAD,FECHA_EFECTO,FECHA_INICIO,FECHA_FIN,ACTIVO FROM EXT.CARTERA WHERE NUM_POLIZA = 22610 AND COD_MEDIADOR = '0012' AND COD_SUBCLAVE = '0001' ORDER BY COD_MEDIADOR,NUM_ANUALIDAD;
SELECT * FROM EXT.CSE_DEBUG WHERE PROCESO LIKE '%SP_TRASPASO_OPERACIONES_ESPECIALES_CREDITO%' AND CAST(DATETIME AS DATE) = CURRENT_DATE;
