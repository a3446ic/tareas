CREATE OR REPLACE PROCEDURE EXT.sp_traspaso_porcentaje_mediador_sin_derechos_renovacion_credito (IN caseId BIGINT, IN nombreCasoOrigen VARCHAR(100))
LANGUAGE SQLSCRIPT 
AS
/*
	----------------------------------------------------------------------------------------------- 
	...
	|---------------------------------------------------------------------------------------------- 
	| Procedure Purpose: TRASPASO % A OTRO MEDIADOR SIN DERECHOS Y OBLIGACIONES A LA RENOVACIÓN
	| 
	| Version: 1	
	|
	| 
