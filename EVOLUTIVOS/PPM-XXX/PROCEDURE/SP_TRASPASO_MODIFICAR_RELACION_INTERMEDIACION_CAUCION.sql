CREATE OR REPLACE PROCEDURE EXT.SP_TRASPASO_MODIFICAR_RELACION_INTERMEDIACION_CAUCION (IN caseId BIGINT, IN nombreCasoOrigen VARCHAR(100))
LANGUAGE SQLSCRIPT 
AS
/*
	----------------------------------------------------------------------------------------------- 
	...
	|---------------------------------------------------------------------------------------------- 
	| Procedure Purpose: MODIFICAR RELACIÓN INTERMEDIACIÓN
	| 
	| Version: 1
...
BEGIN
    ...
    -- CONSTANTES
    DECLARE cReport CONSTANT VARCHAR(250) := 'SP_TRASPASO_MODIFICAR_RELACION_INTERMEDIACION_CAUCION';
