CREATE OR REPLACE PROCEDURE EXT.sp_traspaso_subclaves_credito (IN caseId BIGINT)
LANGUAGE SQLSCRIPT 
AS
/*
	----------------------------------------------------------------------------------------------- 
...
DO BEGIN CREATE OR REPLACE PROCEDURE EXT.sp_traspaso_mediador_mediador_con_derechos_credito (IN caseId BIGINT)
LANGUAGE SQLSCRIPT 
AS
/*
	----------------------------------------------------------------------------------------------- 
...
CALL EXT.sp_traspaso_mediador_mediador_con_derechos_credito(vCASEID);
