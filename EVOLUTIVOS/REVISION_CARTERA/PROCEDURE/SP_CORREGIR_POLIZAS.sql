CREATE PROCEDURE EXT.SP_CORREGIR_POLIZAS(in v_filename VARCHAR(250))
...
BEGIN
    ...
    -- DECLARE :v_filename VARCHAR(250) := '1689_MVCAR_TST_20231202_111111_MovCartera.txt';
    -- DECLARE :v_filename VARCHAR(250) := '1689_MVFID_PRD_20231023_101720_MovFianzas_CARGA_INI.txt';
    ...
    ---------------------------------------------------------------------------------------------------------------------------------------
		...
		-- TEST
		SELECT 'CREDITO ANTES',* FROM  EXT.GET_POLIZAS_CREDITO_ERROR_TEST(:v_filename) ORDER BY NUM_POLIZA,ANUALIDAD;
		SELECT COUNT(*) INTO v_totalFilas FROM EXT.GET_POLIZAS_CREDITO_ERROR_TEST(:v_filename);
		...
		-- TEST
		C_MOTIVOS_ERROR_CREDITO = SELECT ROW_NUMBER() OVER () AS NUM_FILA,* FROM EXT.GET_POLIZAS_CREDITO_ERROR_TEST(:v_filename);
		...
		-- TEST
		SELECT COUNT(*) INTO v_totalFilasCorregidas FROM EXT.GET_POLIZAS_CREDITO_ERROR_TEST(:v_filename);
		-- PRD
		...
		-- TEST
		SELECT 'CREDITO DESPUES',* FROM  EXT.GET_POLIZAS_CREDITO_ERROR_TEST(:v_filename) ORDER BY NUM_POLIZA,ANUALIDAD;
		-- PRD
		-- SELECT * FROM  EXT.GET_POLIZAS_CREDITO_ERROR();
		---------------------------------------------------------------------------------------------------------------------------------------
	...
	ELSE
		...
		-- TEST
		SELECT 'CAUCION ANTES',* FROM  EXT.GET_POLIZAS_CAUCION_ERROR_TEST(:v_filename);
		SELECT COUNT(*) INTO v_totalFilas FROM EXT.GET_POLIZAS_CAUCION_ERROR_TEST(:v_filename);
		...
		-- TEST
		C_MOTIVOS_ERROR_CAUCION = SELECT ROW_NUMBER() OVER () AS NUM_FILA,* FROM EXT.GET_POLIZAS_CAUCION_ERROR_TEST(:v_filename);
		-- PRD
		...
		-- TEST
		SELECT COUNT(*) INTO v_totalFilasCorregidas FROM EXT.GET_POLIZAS_CAUCION_ERROR_TEST(:v_filename);
		-- PRD
		...
		---------------------------------------------------------------------------------------------------------------------------------------
		-- TEST
		SELECT 'CAUCION DESPUES',* FROM  EXT.GET_POLIZAS_CAUCION_ERROR_TEST(:v_filename);
	END IF;
